...
setTimeout(() => {
    ...
    console.log(chalk.cyan("  │") + chalk.whiteBright("  Author    : ") + chalk.cyanBright("AmaneOfc") + "                    " + chalk.cyan("│"));
    console.log(chalk.cyan("  │") + chalk.whiteBright("  Status    : ") + chalk.greenBright("Connected & Running") + "       " + chalk.cyan("│"));
    console.log(chalk.cyan("  │") + chalk.redBright("  [!] MASUKAN NOMOR WHATSAPP BOT") + "        " + chalk.cyan("│"));
    console.log(chalk.cyan("  └────────────────────────────────────────┘\n"));
}, 5000);
